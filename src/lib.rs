...
#[derive(Debug)]
pub struct MaterialUiProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MaterialUiProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MaterialUi processing");
    
    let mut processor = MaterialUiProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MaterialUiProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MaterialUiProcessor::new(false);
